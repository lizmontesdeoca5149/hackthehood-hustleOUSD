...
#Once you are done with all the above steps, running this command python3 arena.py should result in:
#Grace Hopper Health: 200
#Alan Turing Health: 150
#Grace Hopper attacks with a total damage of 72
#Alan Turing defends with a total block of 9
#Alan Turing's Health after attack: 87
#Alan Turing is still standing!
#The winner is: Grace Hopper
